...
app = modal.App(name="heroicons-flux")
...
def fastapi_app():
    ...
    def go(text=""):
        ...
        print(text, config)
        image, prompt = Model(hyperparameter_model_dir="lr_0.0002_steps_4000_rank_16").inference.remote(
            text, config
        )
        return image
    ...
    example_prompts = [
        ...
        "An HCON, a black and white minimalist icon of a mitochondrion",
        "An HCON, a black and white minimalist icon of Steve Jobs",
    ]

    # add a gradio UI around inference
    with gr.Blocks( title="Heroicons Dreambooth on Modal"
    ) as interface:
        gr.Markdown(
